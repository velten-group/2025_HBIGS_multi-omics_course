...
This file recapitulates the first steps of R programming. If you are completely new to R or think a recap would be helpful, I would recommend to watch this [youtube video](https://www.youtube.com/watch?v=p8F_wreHTzw) and go through the Swirl tutorial on *R Programming: The basics of programming in R*.
...
<mark>**Task 11: Knit the .Rmd file with all your changes and solutions by clicking on the "Knit button". Make sure to change the author name to your name before knitting.  ** </mark>
